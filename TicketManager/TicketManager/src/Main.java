...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Llamado a la clase cliente
        Cliente objetoCliente = new Cliente(idViaje, origen, destino, fecha, hora, matriculaBus, precio, idCliente, idCompra, cliente, horaTicket);
        // ---------------------------------------------
                                            ...
                                            case 4:
                                                do {
                                                    ...
                                                    if (validElim.equals(password1)) {
                                                        ...
                                                        //Funciones.guardarRegistrosVentas(listaRegistrosVentas);
                                                        valid16 = 0;
                                                    } else {
