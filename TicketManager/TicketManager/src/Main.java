...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Variables
        String matriculaBus = "", horaTicket="", fecha="", origen="", destino="", hora="";
        ...
        List<Ticket> listaRegistrosVentas = Funciones.cargarListaTickets();
        // ---------------------------------------------
                                        ...
                                        switch (valid3) {
                                            ...
                                            case 1:
                                                do {
                                                    ...
                                                    matriculaBus = scanner.nextLine();
                                                    System.out.println("║ Introduce el precio del ticket:           ║");
                                                    precio = scanner.nextInt();
                                                    scanner.nextLine();
                                                    System.out.println("╚===========================================╝");
                                                    Viaje viajes = new Viaje(idViaje, origen, destino, fecha, hora, matriculaBus, precio, idCliente, idCompra, cliente, horaTicket);
                                                ...
                                                try {
                                                    do {
                                                        ...
                                                        for (Ticket venta : listaRegistrosVentas) {
                                                            ...
                                                            System.out.println("Hora compra: "+ venta.getHoraTicket());
                                                            System.out.println("-----------------------------------------\n");
                                                        }
                                                        System.out.println("╚====================================================╝");
                                                        System.out.println("1) Salir");
                                            ...
                                            case 4:
                                                do {
                                                    ...
                                                    if (validElim.equals(password1)) {
                                                        ...
                                                        Funciones.guardarListaTickets(listaRegistrosVentas);
                                                        valid16 = 0;
                                                    } else {
                        ...
                        switch (valid2) {
                                        ...
                                        for (Ticket ticket : listaViajes) {
                                            if (ticket.getIdViaje().equals(idTicketCompra)) {
                                                ...
                                                if (validPwd.equals(password2)) {
                                                    ...
                                                    horaTicket = horaActual.format(formatoHora);
                                                    ticket.setHoraTicket(horaTicket);
                                                    ticket.setCliente(cliente);
                                                    ticket.setIdCliente(idCliente);
                                                    ticket.setIdCompra(idCompra);
                                                    System.out.println("Compra exitosa!");
                                                    System.out.println("--------------- TICKET ----------------");
                                                    System.out.println("ID Viaje: "+ ticket.getIdViaje());
                                                    ...
                                                    System.out.println("Hora de salida: " + ticket.getHora());
                                                    ...
                                                    System.out.println("Hora compra: "+ ticket.getHoraTicket());
                                                    System.out.println("-----------------------------------------");
                                                    listaRegistrosVentas.add(new Ticket(ticket.getIdViaje(), ticket.getOrigen(), ticket.getDestino(), ticket.getFecha(), ticket.getHora(), ticket.getMatriculaBus(), ticket.getPrecio(), ticket.getIdCliente(), ticket.getIdCompra(), ticket.getCliente(), ticket.getHoraTicket()));
                                                    Funciones.guardarListaTickets(listaRegistrosVentas);
                            ...
                            case 3:
                                try {
                                    do {
                                        System.out.println("------------ REGISTO DE VENTA DE TICKETS --------------");
                                        for (Ticket ventas : listaRegistrosVentas){
                                            System.out.println("--------------- TICKET ----------------");
                                            System.out.println("Origen: " + ventas.getOrigen());
                                            System.out.println("Destino: " + ventas.getDestino());
                                            System.out.println("Fecha: " + ventas.getFecha());
                                            System.out.println("Hora de salida: " + ventas.getHora());
                                            System.out.println("Bus: " + ventas.getMatriculaBus());
                                            System.out.println("Valor ticket: " + ventas.getPrecio() + "$");
                                            System.out.println("Cliente: " + ventas.getCliente());
                                            System.out.println("ID Cliente: " + ventas.getIdCliente());
                                            System.out.println("ID Compra: " + ventas.getIdCompra());
                                            System.out.println("Hora compra: "+ ventas.getHoraTicket());
                                            System.out.println("-----------------------------------------");
                                        }
                                        System.out.println("1) Salir");
